...
switch ($a)
	...
	case "A": // add
		...
		if ($x_errortext == 'NULL' || $x_errortext == "")		
			...
			$mail_to = $x_email;
			$mail_subject = "MAFOR regisztráció";
			$mail_message = "MAFOR\n"
			. "Üdvözöljük!\n"
			. "Ön regisztrálta magát a honlapunkon!\n"
...
$html_page .= "</tr>";
$html_page .= "<tr>";
$html_page .= "<td bgcolor='" . $actcolor . "'><span class='phpmaker'>Jelszó megerõsítése *&nbsp;</span></td>";
...
$html_page .= "</tr>";
$html_page .= "<tr>";
$html_page .= "<td bgcolor='" . $actcolor . "'><span class='phpmaker'>E-mail cím *&nbsp;</span></td>";
