...
if ($_SESSION[$GLOBALS["which_system"]."status_UserLevel"] == 2 ||
	...
	if ((actual_permission(viewModul("basket","name")) & ewAllowview) == ewAllowview)
		...
		$html_page .= "<table width='60%' border='0' cellspacing='1' cellpadding='2' bgcolor='#CCCCCC'>";
		$html_page .= "<tr>";
		$html_page .= "<td align='center' colspan='2' bgcolor ='#CCCCCC' style='border-style:groove;border-color:#000066;border-width:thin'><font color='#000066' class='phpmaker'><strong>".viewModulParam($modul_select,"users_ordersTitle")."</strong></font></td>";
		$html_page .= "</tr>";
		$html_page .= "</table></td></tr>";
		$html_page .= "<table width='60%' border='0' cellspacing='1' cellpadding='2' bgcolor='#CCCCCC'>";
		$html_page .= "<tr>";
		...
		$html_page .= "<td bgcolor='" . $color6 . "'><span class='phpmaker'>" . $x_forename . "</span>&nbsp;</td>";
		$html_page .= "</tr>";
		$html_page .= "<tr>";
	...
	if ((actual_permission(viewModul("basket","name")) & ewAllowview) == ewAllowview)
		...
		$html_page .= "</tr>";
		$html_page .= "<tr>";
		$html_page .= "<td bgcolor='" . $actcolor . "'><span class='phpmaker'>".viewModulParam($modul_select,"carry_countryTitle")."</span>&nbsp;</td>";
		...
		$html_page .= "</tr>";
		$html_page .= "<tr>";
		$html_page .= "<td bgcolor='" . $actcolor . "'><span class='phpmaker'>".viewModulParam($modul_select,"bill_surnameTitle")."</span>&nbsp;</td>";
