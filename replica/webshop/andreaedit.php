...
switch ($a)
	...
	case "U": // update
		if ($x_errortext == 'NULL' || $x_errortext == "")		
			...
			// code
			$theValue = (!get_magic_quotes_gpc()) ? addslashes($x_code) : $x_code;
			$theValue = ($theValue != "") ? " '" . $theValue . "'" : "NULL";
			$fieldList["code"] = $theValue;

			// size
			$theValue = (!get_magic_quotes_gpc()) ? addslashes($x_size) : $x_size;
			$theValue = ($theValue != "") ? " '" . $theValue . "'" : "NULL";
			$fieldList["size"] = $theValue;
...
$html_page .= "</tr>";
$html_page .= "<tr>";
$html_page .= "<td bgcolor='" . $actcolor . "'><span class='phpmaker'>".viewModulParam($modul_select,"codeTitle")."</span>&nbsp;</td>";
$html_page .= "<td bgcolor='" . $color6 . "'><span class='phpmaker'><input type='text' name='x_code' size='20' maxlength='20' value='" . htmlspecialchars(@$x_code) . "'></span>&nbsp;</td>";
$html_page .= "</tr>";
$html_page .= "<tr>";
$html_page .= "<td bgcolor='" . $actcolor . "'><span class='phpmaker'>".viewModulParam($modul_select,"sizeTitle")." *</span>&nbsp;</td>";
$html_page .= "<td bgcolor='" . $color6 . "'><span class='phpmaker'><input type='text' name='x_size' size='20' maxlength='20' value='" . htmlspecialchars(@$x_size) . "'></span>&nbsp;</td>";
$html_page .= "</tr>";
$html_page .= "<tr>";
$html_page .= "<td bgcolor='" . $actcolor . "'><span class='phpmaker'>".viewModulParam($modul_select,"priceTitle")." *</span>&nbsp;</td>";
$html_page .= "<td bgcolor='" . $color6 . "'><span class='phpmaker'><input type='text' name='x_price' size='10' value='" . htmlspecialchars(@$x_price) . "'></span>&nbsp;</td>";
$html_page .= "</tr>";
...
switch (document.editform.fieldfocus.value)
	...
	case "x_priceHUF" : document.editform.x_priceHUF.focus();
		break;
	default : document.editform.x_barcode.focus();
		break;
	}
-->
</script>
